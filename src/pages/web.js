...
import { fetchWebProjects } from "@/utils"
    ...
    <Layout>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            UI Design Modification for Project &quot;KnightHawk&quot;{" "}
            <em>Android App</em>
          </li>
          <li>
          ...
          <li>
            ...
            Part of the &quot;Sales Leader Tools&quot; package. Allows Sales
            leaders view thier agents office locations, view their goals,
            contact their agents, and view agents business plan and metrics.
          </li>
        ...
        <ul>
          ...
          <li>
            <strong>Role:</strong> Web Designer/Developer
            <br />
            TeacherzPetz - Squarespace
          </li>
        </ul>
      </div>
    </Layout>
