  ...
  return (
    <Layout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card
          link="/drawing/drawingOne"
          title="Gamers Still Life Drawing"
          text="View Description"
          width={width}
          height={height}
          img="https://jk-docs.s3.us-east-2.amazonaws.com/images/thumb/drawing/drawing1.jpg"
        />
        <Card
          link="/drawing/drawingTwo"
          title="I'm burning Inside"
          text="View Description"
          width={width}
          height={height}
          img="https://jk-docs.s3.us-east-2.amazonaws.com/images/thumb/drawing/drawing2.jpg"
        />
        <Card
          link="/drawing/drawingThree"
          title="Ribcage Study"
          text="View Description"
          width={width}
          height={height}
        ...
        />
        <Card
          link="/drawing/drawingFour"
          title="Nude Study 1"
          text="View Description"
          width={width}
          height={height}
          img="https://jk-docs.s3.us-east-2.amazonaws.com/images/thumb/drawing/drawing6.jpg"
        />
        <Card
          link="/drawing/drawingFive"
          title="Facial Study 1"
          text="View Description"
          width={width}
          height={height}
          img="https://jk-docs.s3.us-east-2.amazonaws.com/images/thumb/drawing/drawing7.jpg"
        />
        <Card
