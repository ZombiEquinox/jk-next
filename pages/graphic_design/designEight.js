  ...
  return(
    <Layout>
      ...
      <div>
        ...
        <Image src="https://jk-docs.s3.us-east-2.amazonaws.com/images/graphic_design/graphicdesign16.png" width={637} height={825} />
        <Image src="https://jk-docs.s3.us-east-2.amazonaws.com/images/graphic_design/graphicdesign17.jpg" width={637} height={825} />
        <Image src="https://jk-docs.s3.us-east-2.amazonaws.com/images/graphic_design/graphicdesign18.jpg" width={637} height={825} />
        <Image src="https://jk-docs.s3.us-east-2.amazonaws.com/images/graphic_design/graphicdesign19.png" width={637} height={825} />
        <Image src="https://jk-docs.s3.us-east-2.amazonaws.com/images/graphic_design/graphicdesign20.png" width={637} height={825} />
      </div>
    </Layout>
  )
}