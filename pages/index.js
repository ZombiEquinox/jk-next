    ...
    <LayoutHome>
      ...
      <section id="portfolio">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card link="/web" title="Web Development and Design" text="View Web" img="https://jk-docs.s3.us-east-2.amazonaws.com/images/thumb/web/bep.jpg" width={width} height={height}/>
