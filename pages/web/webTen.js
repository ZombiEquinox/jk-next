  ...
  return(
    <Layout>
      ...
      <div>
        ...
        <Image src='https://jk-docs.s3.us-east-2.amazonaws.com/images/web/riverplex-app.png' width="720px" height="1280px" />              
        <Image src='https://jk-docs.s3.us-east-2.amazonaws.com/images/web/riverplex-app1.png' width="720px" height="1280px" />              
      </div>
    </Layout>
  )
}