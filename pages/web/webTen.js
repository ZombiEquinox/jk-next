...
import image from '../../public/images/web/riverplex-app.png'
import image2 from '../../public/images/web/riverplex-app1.png'
  ...
  return(
    <Layout>
      ...
      <div>
        ...
        <Image src={image} width="720px" height="1280px" />              
        <Image src={image2} width="720px" height="1280px" />              
      </div>
    </Layout>
  )
}